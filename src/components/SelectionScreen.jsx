...
function SelectionScreen({ setDisplayState, formattedRestaurants, handleSelection, counter, setCounter }) {
  // const restaurant1 = {
  ...
  useEffect(() => {
    if (formattedRestaurants) {
      setRestaurant1(formattedRestaurants[0]);
      setRestaurant2(formattedRestaurants[1]);
    }
            ...
            <Card style={{ marginTop: "20px", marginBottom: "10px" }}>
              <CardFooter style={{ display: "flex", flexDirection: "row", justifyContent: "center" }}>
                <ButtonGroup spacing='2'>
                  <Button onClick={() => { handleSelection(1); setDisplayState(4); setCounter((ex) => ex + 1)}} variant='solid' backgroundColor="#2e8c86" color="white">
                    Option 1
                  </Button>
                  <Button onClick={() => { handleSelection(2); setDisplayState(4); setCounter((ex) => ex + 1)}} variant='solid' backgroundColor="#2e8c86" color="white">
                    Option 2
                  </Button>
                </ButtonGroup>
              </CardFooter>
